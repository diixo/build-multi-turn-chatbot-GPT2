...
### 1. DailyDialog Data
If you want to train on the DailyDialog dataset, simply set the `dailydialog_dataset_train` value in the `config/project.yaml` file to `True` as follows.
```yaml
...
### 2. Custom Data
If you want to train your custom dataset, set the `dailydialog_dataset_train` value in the `config/project.yaml` file to `False` as follows.
